...
{
    #[Route('/dashboard/sponsors', name: 'app_sponsor_index', methods: ['GET'])]
    ...
    #[Route('/sponsor/{id}', name: 'app_sponsore_show')]
    public function showSponsor(SponsorRepository $sponsorRepository, $id): Response
    {
        ...
        return $this->render('sponsor/showF.html.twig', [
            'sponsor' => $sponsor,
        ]);
    }
}
